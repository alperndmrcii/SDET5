...
public class _01_ScroolingIntro extends BaseDriver {
    /*
   ...
   */
    ...
    public void Test1() {
        ...
        MyFunc.Bekle(3);
        // Actions aksiyonlar = new Actions(driver); // bu da driver üzerinden aksiyon işlemleri için
        ...
        js.executeScript("window.scrollBy(0,3000)"); // 1000 dediği ekrandaki çözünürlük
       //(0,1500) -> (x,y) sayfayı sağa x kadar ve ağaı y kaydırır
